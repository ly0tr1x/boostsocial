...
For 5 different profiles with different quantities, Format will be:",
 ...
 "social_ava" => "Social Networks Available", 
 "social_fb" => "Increasing followers on Facebook not only expands visibility and engagement but also builds trust with new visitors. We offer services such as likes, followers, views, video playback, and live views to boost your presence on the platform.", 
 "social_tk" => "Gaining followers on TikTok not only enhances visibility and engagement but also builds trust with new viewers. We offer services such as likes, followers, and other options to strengthen your presence on the platform.", 
 "social_tw" => "Increasing followers on Twitch not only expands visibility and engagement but also builds trust with new visitors. We offer services such as followers, live views, and other options to strengthen your presence on the platform.", 
 "social_ig" => "Boosting followers on Instagram not only enhances visibility and engagement but also builds trust with new visitors. We provide services such as likes, followers, views, video playback, and live views to elevate your presence on the platform.", 
 "social_yt" => "Increasing subscribers on YouTube not only expands visibility and engagement but also builds trust with new visitors. We offer services such as likes, video views, and others to strengthen your presence on the platform.", 
 "social_sp" => "Boosting followers on Spotify not only enhances visibility and engagement but also builds trust with new listeners. We offer services such as increasing followers and other options to strengthen your presence on the platform.", 
 "social_twi" => "Increasing followers on Twitter not only expands visibility and engagement but also builds trust with new followers. We offer services such as likes, retweets, and other options to strengthen your presence on the platform.", 
 "social_tg" => "Growing followers on Telegram not only enhances visibility and engagement but also builds trust with new members. We offer services such as increasing followers and other options to strengthen your presence on the platform.", 
...
Promotion Service Our goal is to improve your presence on social networks. Although we cannot guarantee engagement from new followers, we are committed to providing you with the followers you have paid for.",
 ...
 "orders.button.refill" => "Refill", 
  ...
  "refill_desc" => "You can see all your refill on our site here.  ", 
 ...
 "title_login"  => "Are you looking for the best social media services?",
 "title_login2"  => " Social Boost is the ultimate online platform where you can boost your likes and followers on Instagram, TikTok, Facebook, and various other networks. Using our platform is incredibly simple. <br> What are you waiting for? Elevate your social media presence now! ",
...
"Top_Up_Account_Text"  => "Make your payment with the payment option that suits you.",
"Order_Service"  => "Order Service",
"Order_Service_Text"  => "You are interested in and place your order easily.",
"Enjoy"  => "Boost your networks",
"Enjoy_Text"  => "Enjoy increasing your social networks with us",
"prices_start" => "Prices start from",
"Our_Platforms" => "Our platforms Available",
"login_text_info1" => "User Friendly, Fast and Dynamic Panel",
"login_text_info2" => "An SMM Panel, which stands for Social Media Marketing and SEO Services Reseller Panel, serves as a cost-effective platform where individuals can buy and sell various social media marketing services. This includes acquiring Facebook fans, Twitter followers, Instagram followers, YouTube watch time views, website traffic, TikTok likes, and other significant social networks. It is widely used to enhance social media presence and build trust among new visitors to your networks.",
