...
use _PhpScoper54524b0fd82d\Composer\CaBundle\CaBundle;
use _PhpScoper54524b0fd82d\GuzzleHttp\Client;
use _PhpScoper54524b0fd82d\GuzzleHttp\ClientInterface;
use _PhpScoper54524b0fd82d\GuzzleHttp\Exception\GuzzleException;
use _PhpScoper54524b0fd82d\GuzzleHttp\HandlerStack;
use _PhpScoper54524b0fd82d\GuzzleHttp\Psr7\Request;
use _PhpScoper54524b0fd82d\GuzzleHttp\RequestOptions as GuzzleRequestOptions;
use Mollie\Api\Exceptions\ApiException;
use _PhpScoper54524b0fd82d\Psr\Http\Message\ResponseInterface;
final class Guzzle6And7MollieHttpAdapter implements \Mollie\Api\HttpAdapter\MollieHttpAdapterInterface
{
    ...
    public function __construct(\_PhpScoper54524b0fd82d\GuzzleHttp\ClientInterface $httpClient)
    {
    ...
    public static function createDefault()
    {
        ...
        $handlerStack = \_PhpScoper54524b0fd82d\GuzzleHttp\HandlerStack::create();
        $handlerStack->push($retryMiddlewareFactory->retry());
        $client = new \_PhpScoper54524b0fd82d\GuzzleHttp\Client([\_PhpScoper54524b0fd82d\GuzzleHttp\RequestOptions::VERIFY => \_PhpScoper54524b0fd82d\Composer\CaBundle\CaBundle::getBundledCaBundlePath(), \_PhpScoper54524b0fd82d\GuzzleHttp\RequestOptions::TIMEOUT => self::DEFAULT_TIMEOUT, \_PhpScoper54524b0fd82d\GuzzleHttp\RequestOptions::CONNECT_TIMEOUT => self::DEFAULT_CONNECT_TIMEOUT, 'handler' => $handlerStack]);
    ...
    {
        $request = new \_PhpScoper54524b0fd82d\GuzzleHttp\Psr7\Request($httpMethod, $url, $headers, $httpBody);
        try {
            $response = $this->httpClient->send($request, ['http_errors' => \false]);
        } catch (\_PhpScoper54524b0fd82d\GuzzleHttp\Exception\GuzzleException $e) {
     ...
     * @throws ApiException
     */
    private function parseResponseBody(\_PhpScoper54524b0fd82d\Psr\Http\Message\ResponseInterface $response)
    {
    ...
    public function versionString()
    {
        if (\defined('\\GuzzleHttp\\ClientInterface::MAJOR_VERSION')) {
            // Guzzle 7
            return "Guzzle/" . \_PhpScoper54524b0fd82d\GuzzleHttp\ClientInterface::MAJOR_VERSION;
        } elseif (\defined('\\GuzzleHttp\\ClientInterface::VERSION')) {
            // Before Guzzle 7
            return "Guzzle/" . \_PhpScoper54524b0fd82d\GuzzleHttp\ClientInterface::VERSION;
        }
        return null;
    }
}
